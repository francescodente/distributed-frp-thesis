...
The proposed solution is to combine aggregate computing with the functional reactive programming to develop an evolution of the current model proposed by field calculus that allows to effectively specify aggregate computations as reactions to changes in the environment.
%
Additionally, a small prototype has been developed to assess the applicability of the proposed model and to verify that some of the properties of the original model remain observable in the new one.
%
