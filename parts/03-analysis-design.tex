...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{figures/diagrams/design.pdf}
...
%
In cases where alignment isn't possible (i.e. on the first evaluation or after a switch of branch), the first argument of loop should be used to construct a new export (\Cref{fig:semantics-loop-init}).
%
